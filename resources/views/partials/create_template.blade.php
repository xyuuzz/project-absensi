    ...
    <form wire:submit.prevent='createForm' class="mt-3">
        ...
        @elseif($status === "student")
            <div class="form-group">
                ...
                <input required id="nis" type="text" {{ $nis }} class="form-control" wire:model="nis" placeholder="Masukan NIS Milik Siswa">
            ...
            <div class="form-group">
                ...
                <input required id="nisn" type="number" class="form-control" wire:model="no_absen" placeholder="Masukan No Absen Siswa">
