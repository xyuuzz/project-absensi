<div>
    ...
    <form wire:submit.prevent='createForm'>
        <div class="form-group">
            ...
            <input required id="nama_guru" type="text" class="form-control" placeholder="Nama Guru"
        ...
        <div class="form-group">
            ...
            <input required id="mapel" type="text" placeholder='Mapel yang Diampu oleh Guru' class="form-control"
                wire:model="mapel">
